...
PROTOBUF_NAMESPACE_OPEN
template <>
::RPC::RpcHeader* Arena::CreateMaybeMessage<::RPC::RpcHeader>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace RPC {
...
class RpcHeader PROTOBUF_FINAL
   ...
   public:
    ...
    RpcHeader(RpcHeader&& from) noexcept : RpcHeader() { *this = ::std::move(from); }
    ...
    inline RpcHeader* New() const final { return CreateMaybeMessage<RpcHeader>(nullptr); }

    RpcHeader* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final { return CreateMaybeMessage<RpcHeader>(arena); }
   ...
   private:
    ...
    static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "RPC.RpcHeader"; }
...
inline const std::string& RpcHeader::_internal_service_name() const { return service_name_.Get(); }
...
inline void RpcHeader::set_service_name(std::string&& value) {
    service_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value),
                      GetArena());
...
inline void RpcHeader::set_service_name(const void* value, size_t size) {
    service_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline void RpcHeader::unsafe_arena_set_allocated_service_name(std::string* service_name) {
    GOOGLE_DCHECK(GetArena() != nullptr);
    if (service_name != nullptr) {
    } else {
    }
...
inline const std::string& RpcHeader::_internal_method_name() const { return method_name_.Get(); }
...
inline void RpcHeader::set_method_name(std::string&& value) {
    method_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
...
inline void RpcHeader::set_method_name(const void* value, size_t size) {
    method_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
                     ::std::string(reinterpret_cast<const char*>(value), size), GetArena());
...
inline void RpcHeader::unsafe_arena_set_allocated_method_name(std::string* method_name) {
    GOOGLE_DCHECK(GetArena() != nullptr);
    if (method_name != nullptr) {
    } else {
    }
    method_name_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), method_name,
                                         GetArena());
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 RpcHeader::_internal_args_size() const { return args_size_; }
...
inline void RpcHeader::_internal_set_args_size(::PROTOBUF_NAMESPACE_ID::uint32 value) { args_size_ = value; }
