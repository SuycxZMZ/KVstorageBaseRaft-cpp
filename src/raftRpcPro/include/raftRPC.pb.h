...
PROTOBUF_NAMESPACE_OPEN
template <>
::raftRpcProctoc::AppendEntriesArgs* Arena::CreateMaybeMessage<::raftRpcProctoc::AppendEntriesArgs>(Arena*);
template <>
::raftRpcProctoc::AppendEntriesReply* Arena::CreateMaybeMessage<::raftRpcProctoc::AppendEntriesReply>(Arena*);
template <>
::raftRpcProctoc::InstallSnapshotRequest* Arena::CreateMaybeMessage<::raftRpcProctoc::InstallSnapshotRequest>(Arena*);
template <>
::raftRpcProctoc::InstallSnapshotResponse* Arena::CreateMaybeMessage<::raftRpcProctoc::InstallSnapshotResponse>(Arena*);
template <>
::raftRpcProctoc::LogEntry* Arena::CreateMaybeMessage<::raftRpcProctoc::LogEntry>(Arena*);
template <>
::raftRpcProctoc::RequestVoteArgs* Arena::CreateMaybeMessage<::raftRpcProctoc::RequestVoteArgs>(Arena*);
template <>
::raftRpcProctoc::RequestVoteReply* Arena::CreateMaybeMessage<::raftRpcProctoc::RequestVoteReply>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace raftRpcProctoc {
...
class LogEntry PROTOBUF_FINAL
   ...
   public:
    ...
    LogEntry(LogEntry&& from) noexcept : LogEntry() { *this = ::std::move(from); }
    ...
    static inline const LogEntry* internal_default_instance() {
        return reinterpret_cast<const LogEntry*>(&_LogEntry_default_instance_);
    }
    ...
    inline LogEntry* New() const final { return CreateMaybeMessage<LogEntry>(nullptr); }

    LogEntry* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final { return CreateMaybeMessage<LogEntry>(arena); }
   ...
   private:
    ...
    static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "raftRpcProctoc.LogEntry"; }
   ...
   public:
    ...
    GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
        ...
        "    string fields are deprecated and will be removed in a"
        "    future release.")
    void unsafe_arena_set_allocated_command(std::string* command);
...
class AppendEntriesArgs PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:raftRpcProctoc.AppendEntriesArgs) */ {
   public:
    ...
    AppendEntriesArgs(AppendEntriesArgs&& from) noexcept : AppendEntriesArgs() { *this = ::std::move(from); }
    ...
    static inline const AppendEntriesArgs* internal_default_instance() {
        return reinterpret_cast<const AppendEntriesArgs*>(&_AppendEntriesArgs_default_instance_);
    }
    ...
    inline AppendEntriesArgs* New() const final { return CreateMaybeMessage<AppendEntriesArgs>(nullptr); }
   ...
   private:
    ...
    friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
    static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "raftRpcProctoc.AppendEntriesArgs"; }
   ...
   public:
    ...
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::raftRpcProctoc::LogEntry>* mutable_entries();
   ...
   public:
    ...
    const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::raftRpcProctoc::LogEntry>& entries() const;
...
class AppendEntriesReply PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:raftRpcProctoc.AppendEntriesReply) */ {
   public:
    ...
    AppendEntriesReply(AppendEntriesReply&& from) noexcept : AppendEntriesReply() { *this = ::std::move(from); }
    ...
    static inline const AppendEntriesReply* internal_default_instance() {
        return reinterpret_cast<const AppendEntriesReply*>(&_AppendEntriesReply_default_instance_);
    }
    ...
    inline AppendEntriesReply* New() const final { return CreateMaybeMessage<AppendEntriesReply>(nullptr); }
   ...
   private:
    ...
    friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
    static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "raftRpcProctoc.AppendEntriesReply"; }
...
class RequestVoteArgs PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:raftRpcProctoc.RequestVoteArgs) */ {
   public:
    inline RequestVoteArgs() : RequestVoteArgs(nullptr){};
    virtual ~RequestVoteArgs();

    RequestVoteArgs(const RequestVoteArgs& from);
    RequestVoteArgs(RequestVoteArgs&& from) noexcept : RequestVoteArgs() { *this = ::std::move(from); }
    ...
    static inline const RequestVoteArgs* internal_default_instance() {
        return reinterpret_cast<const RequestVoteArgs*>(&_RequestVoteArgs_default_instance_);
    }
    ...
    inline RequestVoteArgs* New() const final { return CreateMaybeMessage<RequestVoteArgs>(nullptr); }
   ...
   private:
    ...
    friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
    static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "raftRpcProctoc.RequestVoteArgs"; }
...
class RequestVoteReply PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:raftRpcProctoc.RequestVoteReply) */ {
   public:
    inline RequestVoteReply() : RequestVoteReply(nullptr){};
    virtual ~RequestVoteReply();

    RequestVoteReply(const RequestVoteReply& from);
    RequestVoteReply(RequestVoteReply&& from) noexcept : RequestVoteReply() { *this = ::std::move(from); }
    ...
    static inline const RequestVoteReply* internal_default_instance() {
        return reinterpret_cast<const RequestVoteReply*>(&_RequestVoteReply_default_instance_);
    }
    ...
    inline RequestVoteReply* New() const final { return CreateMaybeMessage<RequestVoteReply>(nullptr); }
   ...
   private:
    ...
    friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
    static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "raftRpcProctoc.RequestVoteReply"; }
...
class InstallSnapshotRequest PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:raftRpcProctoc.InstallSnapshotRequest) */ {
   public:
    ...
    InstallSnapshotRequest(InstallSnapshotRequest&& from) noexcept : InstallSnapshotRequest() {
        *this = ::std::move(from);
    }
    ...
    static inline const InstallSnapshotRequest* internal_default_instance() {
        return reinterpret_cast<const InstallSnapshotRequest*>(&_InstallSnapshotRequest_default_instance_);
    }
    ...
    inline InstallSnapshotRequest* New() const final { return CreateMaybeMessage<InstallSnapshotRequest>(nullptr); }
   ...
   private:
    ...
    friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
    static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "raftRpcProctoc.InstallSnapshotRequest"; }
...
class InstallSnapshotResponse PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:raftRpcProctoc.InstallSnapshotResponse) */ {
   public:
    ...
    InstallSnapshotResponse(InstallSnapshotResponse&& from) noexcept : InstallSnapshotResponse() {
        *this = ::std::move(from);
    }
    ...
    static inline const InstallSnapshotResponse* internal_default_instance() {
        return reinterpret_cast<const InstallSnapshotResponse*>(&_InstallSnapshotResponse_default_instance_);
    }
    ...
    inline InstallSnapshotResponse* New() const final { return CreateMaybeMessage<InstallSnapshotResponse>(nullptr); }
   ...
   private:
    ...
    friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
    static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "raftRpcProctoc.InstallSnapshotResponse"; }
...
class raftRpc : public ::PROTOBUF_NAMESPACE_ID::Service {
   ...
   public:
    ...
    void CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
                    ::PROTOBUF_NAMESPACE_ID::RpcController* controller, const ::PROTOBUF_NAMESPACE_ID::Message* request,
...
inline const std::string& LogEntry::_internal_command() const { return command_.Get(); }
...
inline void LogEntry::set_command(std::string&& value) {
    command_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
...
inline void LogEntry::set_command(const char* value) {
    ...
    command_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value), GetArena());
...
inline void LogEntry::set_command(const void* value, size_t size) {
    command_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline void LogEntry::set_allocated_command(std::string* command) {
    ...
    command_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), command, GetArena());
...
inline std::string* LogEntry::unsafe_arena_release_command() {
    ...
    return command_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void LogEntry::unsafe_arena_set_allocated_command(std::string* command) {
    GOOGLE_DCHECK(GetArena() != nullptr);
    if (command != nullptr) {
    } else {
    }
    command_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), command,
                                     GetArena());
    // @@protoc_insertion_point(field_unsafe_arena_set_allocated:raftRpcProctoc.LogEntry.Command)
}

// int32 LogTerm = 2;
inline void LogEntry::clear_logterm() { logterm_ = 0; }
inline ::PROTOBUF_NAMESPACE_ID::int32 LogEntry::_internal_logterm() const { return logterm_; }
...
inline void LogEntry::_internal_set_logterm(::PROTOBUF_NAMESPACE_ID::int32 value) { logterm_ = value; }
...
// int32 LogIndex = 3;
inline void LogEntry::clear_logindex() { logindex_ = 0; }
inline ::PROTOBUF_NAMESPACE_ID::int32 LogEntry::_internal_logindex() const { return logindex_; }
...
inline void LogEntry::_internal_set_logindex(::PROTOBUF_NAMESPACE_ID::int32 value) { logindex_ = value; }
...
// int32 Term = 1;
inline void AppendEntriesArgs::clear_term() { term_ = 0; }
inline ::PROTOBUF_NAMESPACE_ID::int32 AppendEntriesArgs::_internal_term() const { return term_; }
...
inline void AppendEntriesArgs::_internal_set_term(::PROTOBUF_NAMESPACE_ID::int32 value) { term_ = value; }
...
// int32 LeaderId = 2;
inline void AppendEntriesArgs::clear_leaderid() { leaderid_ = 0; }
inline ::PROTOBUF_NAMESPACE_ID::int32 AppendEntriesArgs::_internal_leaderid() const { return leaderid_; }
...
inline void AppendEntriesArgs::_internal_set_leaderid(::PROTOBUF_NAMESPACE_ID::int32 value) { leaderid_ = value; }
...
// int32 PrevLogIndex = 3;
inline void AppendEntriesArgs::clear_prevlogindex() { prevlogindex_ = 0; }
inline ::PROTOBUF_NAMESPACE_ID::int32 AppendEntriesArgs::_internal_prevlogindex() const { return prevlogindex_; }
...
// int32 PrevLogTerm = 4;
inline void AppendEntriesArgs::clear_prevlogterm() { prevlogterm_ = 0; }
inline ::PROTOBUF_NAMESPACE_ID::int32 AppendEntriesArgs::_internal_prevlogterm() const { return prevlogterm_; }
...
inline void AppendEntriesArgs::_internal_set_prevlogterm(::PROTOBUF_NAMESPACE_ID::int32 value) { prevlogterm_ = value; }
...
// repeated .raftRpcProctoc.LogEntry Entries = 5;
inline int AppendEntriesArgs::_internal_entries_size() const { return entries_.size(); }
inline int AppendEntriesArgs::entries_size() const { return _internal_entries_size(); }
inline void AppendEntriesArgs::clear_entries() { entries_.Clear(); }
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::raftRpcProctoc::LogEntry>* AppendEntriesArgs::mutable_entries() {
...
inline ::raftRpcProctoc::LogEntry* AppendEntriesArgs::_internal_add_entries() { return entries_.Add(); }
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::raftRpcProctoc::LogEntry>& AppendEntriesArgs::entries() const {
    // @@protoc_insertion_point(field_list:raftRpcProctoc.AppendEntriesArgs.Entries)
    return entries_;
}

// int32 LeaderCommit = 6;
inline void AppendEntriesArgs::clear_leadercommit() { leadercommit_ = 0; }
inline ::PROTOBUF_NAMESPACE_ID::int32 AppendEntriesArgs::_internal_leadercommit() const { return leadercommit_; }
...
// int32 Term = 1;
inline void AppendEntriesReply::clear_term() { term_ = 0; }
inline ::PROTOBUF_NAMESPACE_ID::int32 AppendEntriesReply::_internal_term() const { return term_; }
...
inline void AppendEntriesReply::_internal_set_term(::PROTOBUF_NAMESPACE_ID::int32 value) { term_ = value; }
...
// bool Success = 2;
inline void AppendEntriesReply::clear_success() { success_ = false; }
inline bool AppendEntriesReply::_internal_success() const { return success_; }
...
inline void AppendEntriesReply::_internal_set_success(bool value) { success_ = value; }
...
// int32 UpdateNextIndex = 3;
inline void AppendEntriesReply::clear_updatenextindex() { updatenextindex_ = 0; }
inline ::PROTOBUF_NAMESPACE_ID::int32 AppendEntriesReply::_internal_updatenextindex() const { return updatenextindex_; }
...
// int32 AppState = 4;
inline void AppendEntriesReply::clear_appstate() { appstate_ = 0; }
inline ::PROTOBUF_NAMESPACE_ID::int32 AppendEntriesReply::_internal_appstate() const { return appstate_; }
...
inline void AppendEntriesReply::_internal_set_appstate(::PROTOBUF_NAMESPACE_ID::int32 value) { appstate_ = value; }
...
// int32 Term = 1;
inline void RequestVoteArgs::clear_term() { term_ = 0; }
inline ::PROTOBUF_NAMESPACE_ID::int32 RequestVoteArgs::_internal_term() const { return term_; }
...
inline void RequestVoteArgs::_internal_set_term(::PROTOBUF_NAMESPACE_ID::int32 value) { term_ = value; }
...
// int32 CandidateId = 2;
inline void RequestVoteArgs::clear_candidateid() { candidateid_ = 0; }
inline ::PROTOBUF_NAMESPACE_ID::int32 RequestVoteArgs::_internal_candidateid() const { return candidateid_; }
...
inline void RequestVoteArgs::_internal_set_candidateid(::PROTOBUF_NAMESPACE_ID::int32 value) { candidateid_ = value; }
...
// int32 LastLogIndex = 3;
inline void RequestVoteArgs::clear_lastlogindex() { lastlogindex_ = 0; }
inline ::PROTOBUF_NAMESPACE_ID::int32 RequestVoteArgs::_internal_lastlogindex() const { return lastlogindex_; }
...
inline void RequestVoteArgs::_internal_set_lastlogindex(::PROTOBUF_NAMESPACE_ID::int32 value) { lastlogindex_ = value; }
...
// int32 LastLogTerm = 4;
inline void RequestVoteArgs::clear_lastlogterm() { lastlogterm_ = 0; }
inline ::PROTOBUF_NAMESPACE_ID::int32 RequestVoteArgs::_internal_lastlogterm() const { return lastlogterm_; }
...
inline void RequestVoteArgs::_internal_set_lastlogterm(::PROTOBUF_NAMESPACE_ID::int32 value) { lastlogterm_ = value; }
...
// int32 Term = 1;
inline void RequestVoteReply::clear_term() { term_ = 0; }
inline ::PROTOBUF_NAMESPACE_ID::int32 RequestVoteReply::_internal_term() const { return term_; }
...
inline void RequestVoteReply::_internal_set_term(::PROTOBUF_NAMESPACE_ID::int32 value) { term_ = value; }
...
// bool VoteGranted = 2;
inline void RequestVoteReply::clear_votegranted() { votegranted_ = false; }
inline bool RequestVoteReply::_internal_votegranted() const { return votegranted_; }
...
inline void RequestVoteReply::_internal_set_votegranted(bool value) { votegranted_ = value; }
...
// int32 VoteState = 3;
inline void RequestVoteReply::clear_votestate() { votestate_ = 0; }
inline ::PROTOBUF_NAMESPACE_ID::int32 RequestVoteReply::_internal_votestate() const { return votestate_; }
...
inline void RequestVoteReply::_internal_set_votestate(::PROTOBUF_NAMESPACE_ID::int32 value) { votestate_ = value; }
...
// int32 LeaderId = 1;
inline void InstallSnapshotRequest::clear_leaderid() { leaderid_ = 0; }
inline ::PROTOBUF_NAMESPACE_ID::int32 InstallSnapshotRequest::_internal_leaderid() const { return leaderid_; }
...
inline void InstallSnapshotRequest::_internal_set_leaderid(::PROTOBUF_NAMESPACE_ID::int32 value) { leaderid_ = value; }
...
// int32 Term = 2;
inline void InstallSnapshotRequest::clear_term() { term_ = 0; }
inline ::PROTOBUF_NAMESPACE_ID::int32 InstallSnapshotRequest::_internal_term() const { return term_; }
...
inline void InstallSnapshotRequest::_internal_set_term(::PROTOBUF_NAMESPACE_ID::int32 value) { term_ = value; }
...
// int32 LastSnapShotIncludeIndex = 3;
inline void InstallSnapshotRequest::clear_lastsnapshotincludeindex() { lastsnapshotincludeindex_ = 0; }
...
// int32 LastSnapShotIncludeTerm = 4;
inline void InstallSnapshotRequest::clear_lastsnapshotincludeterm() { lastsnapshotincludeterm_ = 0; }
...
inline const std::string& InstallSnapshotRequest::_internal_data() const { return data_.Get(); }
...
inline void InstallSnapshotRequest::unsafe_arena_set_allocated_data(std::string* data) {
    GOOGLE_DCHECK(GetArena() != nullptr);
    if (data != nullptr) {
    } else {
    }
...
// int32 Term = 1;
inline void InstallSnapshotResponse::clear_term() { term_ = 0; }
inline ::PROTOBUF_NAMESPACE_ID::int32 InstallSnapshotResponse::_internal_term() const { return term_; }
...
inline void InstallSnapshotResponse::_internal_set_term(::PROTOBUF_NAMESPACE_ID::int32 value) { term_ = value; }
